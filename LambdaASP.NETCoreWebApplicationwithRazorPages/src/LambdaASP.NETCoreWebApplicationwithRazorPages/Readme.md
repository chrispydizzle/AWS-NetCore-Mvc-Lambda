...
Execute unit tests
```
    cd "BlueprintBaseName/test/LambdaASP.NETCoreWebApplicationwithRazorPages.Tests"
    dotnet test
```

Deploy application
```
    cd "LambdaASP.NETCoreWebApplicationwithRazorPages/src/LambdaASP.NETCoreWebApplicationwithRazorPages"
